...
uploaded_csv = st.sidebar.file_uploader("Upload CSV Data", type=["csv"])
uploaded_geojson = st.sidebar.file_uploader("Upload GeoJSON Data", type=["json"])
...
try:
    if uploaded_geojson is not None:
        # GeoJSON 데이터 로드
        korea_geo = gpd.read_file(uploaded_geojson)
        st.write("### GeoJSON Data Preview:")
        st.write(korea_geo.head())
